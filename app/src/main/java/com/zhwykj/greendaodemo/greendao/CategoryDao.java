...
public class CategoryDao extends AbstractDao<Category, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Category_code = new Property(2, int.class, "category_code", false, "CATEGORY_CODE");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CATEGORY\" (" + //
                ...
                "\"CATEGORY_CODE\" INTEGER NOT NULL );"); // 2: category_code
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Category entity) {
        ...
        stmt.bindLong(3, entity.getCategory_code());
    }
    ...
    public Category readEntity(Cursor cursor, int offset) {
        Category entity = new Category( //
            ...
            cursor.getInt(offset + 2) // category_code
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Category entity, int offset) {
        ...
        entity.setCategory_code(cursor.getInt(offset + 2));
     }
